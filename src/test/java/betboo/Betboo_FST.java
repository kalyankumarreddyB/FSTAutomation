...
public class Betboo_FST extends baseEngine{
	...
	public void betbooBingo() throws Exception{
				...
				Assert.assertTrue(Login.authentication(
							...
							excel.getCellData("labelsFST", 7, 3)), "Login Failed");
					...
					for(int gameCol=1;gameCol<=excel.getRowCount("BetbooBingo");gameCol++) {
						...
						{		
						flag=GetGameList.gameDataFST(excel.getCellData("BetbooBingo", gameCol, 0));
