...
public class ExecutionEngine extends baseEngine{
...
//		System.out.println("excelURL:::"+ URL);
		...
		if(!runMode.equalsIgnoreCase("Y")){
			...
			driver.get(excel.getCellData("labelsFST", 3, 0));
			Thread.sleep(7000);
//			driver.manage().timeouts().implicitlyWait(10000, TimeUnit.SECONDS);
			Reporter.log("Site Launched:::"+excel.getCellData("labelsFST", 3, 0));
			test.info("Logged into the Portal:::"+excel.getCellData("labelsFST", 3, 0));
			
			
			Login.authentication(
					excel.getCellData("labelsFST", 3, 0),
