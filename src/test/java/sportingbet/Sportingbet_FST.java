...
public class Sportingbet_FST extends baseEngine{
	...
	public void sportingBetBingo() throws Exception {	
			...
			Assert.assertTrue(Login.authentication(
						...
						excel.getCellData("labelsFST", 6, 3)), "Login Failed");
				...
				for(int gameCol=1;gameCol<=excel.getRowCount("SportingBetBingo");gameCol++) {
					...
					{		
					flag=GetGameList.gameDataFST(excel.getCellData("SportingBetBingo", gameCol, 0));
