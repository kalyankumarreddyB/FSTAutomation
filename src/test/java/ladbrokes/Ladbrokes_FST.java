...
public class Ladbrokes_FST extends baseEngine{
	...
	public void ladbrokesBingo() throws Exception {			
			...
			Assert.assertTrue(Login.authentication(
						...
						excel.getCellData("labelsFST", 4, 3)), "Login Failed");
				...
				for(int gameCol=1;gameCol<=excel.getRowCount("Ladbrokes");gameCol++) {
					...
					{		
					flag=GetGameList.gameDataFST(excel.getCellData("Ladbrokes", gameCol, 0));
