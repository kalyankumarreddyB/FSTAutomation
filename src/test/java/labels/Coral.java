...
public class Coral extends baseEngine {
	...
	@Test(dataProviderClass=parameterizatedData.class,dataProvider="coral")
	public  void CoralBingo(String URL,String runMode,String username,String password) throws Exception{
