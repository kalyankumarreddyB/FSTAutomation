...
public class Foxy extends baseEngine {
	...
	@Test(dataProviderClass=parameterizatedData.class,dataProvider="foxy")
	public  void FoxyBingo(String URL,String runMode,String username,String password) throws Exception{
